/**
 * Extended branding configuration for the white-labeled FAFLOW application.
 * Governs metadata, support contacts, organizational attributes, and theme defaults.
 */
